	...
	<ScrollArea class="w-full h-full space-y-5">
		<div class="px-4 space-y-2">
			{#each $sortedCoupons as coupon}
				<div class="w-full h-36 rounded-md border p-5 flex flex-col justify-around bg-background cursor-pointer">
					<div>
						...
						<div class="w-full flex justify-between text-sm">
							<a href="https://{coupon.url}" target="_blank"
